        ...
        <form method="post" action="<?php echo base_url('login/aksi_login');?>" id="login_form" role="form">
          <table border="0" style="border:none">
            <tr>
              ...
              <td ><input type="password" tabindex="2" id="pass" placeholder="Password" name="pass" class="inputtext radius1" required></td>
...
<h4 style="color:#141823; text-align:center;">Temukan Akun Anda</h4>
<hr style="width : 400px;">
	<div class="loginboxinner radius">
    	<div class="loginheader">
    		<h4 class="title">Email, Telepon, Nama Pengguna, atau Nama Lengkap</h4>
    	</div><!--loginheader-->
        ...
        <div class="loginform">
        	...
        	<form id="login" action="#" method="post">
            	...
            	<p>
                    <input type="text" id="username" name="username" placeholder="" value="" class="radius" />
                </p>

                <p>
                	<button class="radius title" name="client_login">Cari</button>
                </p>
            </form>
        </div><!--loginform-->
    </div><!--loginboxinner-->
